...
2. Right now, user comments only show when you click on an inidividual creator update in the "Updates" list. There should be an indicator that a post has user comments even before it is clicked.
